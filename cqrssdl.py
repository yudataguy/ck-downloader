...
Thanks to "imguralbum" and "imgurdownloader" scripts' authors for making this 
bot possible. 
    ...
    try:
        for submission in cqrss.entries:
            for model in models_name:
                if model.lower() in submission.title.lower():
                    ...
                    if title and 'imgur.com' in title['href']:
                        ...
                        dl_command = "python imgurdownloader.py " + imgur_link
